        ...
        <div className="card-body p-8">
          ...
          <div className="space-y-6">
            ...
            <div className="form-control mt-8">
              <button className="btn btn-primary btn-lg w-full text-lg font-semibold shadow-lg hover:shadow-primary/30 transform transition-all duration-200 hover:scale-[1.02] active:scale-100">
                Sign In
              </button>
            </div>
          </div>
